      ...
      >
        <div>
          <div className="flex items-center justify-between mb-10">
            ...
            <div className="relative flex items-center justify-center w-11 h-11 rounded-2xl bg-slate-900/50 border border-slate-800/80 shadow-xl">
              <img src="/logo.png" alt="Confidia Logo" className="w-9 h-9 object-contain" />
            </div>
            <div>
